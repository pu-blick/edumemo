            ...
            {isEditingInfo ? (
              ...
              <>
                <div className="relative group">
                  <p className="text-[13px] leading-tight text-slate-400 font-bold tracking-widest uppercase">{student?.student_number}</p>
                  <h1 className="text-[23px] leading-tight font-black text-slate-800 tracking-tight">{student?.name} 학생</h1>
